...
.buy-btn {border:none;border-radius: 50%; width: 70px; height: 50px; background-color: #00f070; color: white; box-shadow: 0 4px 9px 0 rgba(0,0,0,0.80); outline: none; transform:translate(0%,-40%)}
...
<div class="navbar">
  ...
  <a href="index.php" style="text-decoration: none; color: white; font-family: cursive; margin-left: 10px; font-size: 30px; float: left; padding: 14px 16px;">Toy Store</a>
